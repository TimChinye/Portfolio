...
const OLeft = () => (
  <div className="h-full shrink-0 -mr-[0.05ch]" style={{ width: 'var(--o-cap-width)' }}>
    <svg viewBox="0 0 55 343" preserveAspectRatio="none" fill="currentColor" className="size-full">
...
const OCentre = ({ widthProgress }: { widthProgress : MotionValue<number> }) => (
  <motion.div className="h-full" style={{
    ...
    <svg viewBox="54 0 506 343" preserveAspectRatio="none" fill="currentColor" className="size-full">
...
const ORight = () => (
  <div className="h-full shrink-0 -ml-[0.05ch]" style={{ width: 'var(--o-cap-width)' }}>
    <svg viewBox="559 0 56 343" preserveAspectRatio="none" fill="currentColor" className="size-full">
...
export const GrowthText = ({ scrollYProgress, variant, className }: GrowthTextProps) => {
  ...
  return (
    <div
      className={clsx("flex size-full items-center gap-(--gap)", className)}
