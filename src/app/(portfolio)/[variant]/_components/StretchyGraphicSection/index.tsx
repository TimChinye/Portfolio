    ...
    >
      {(contentProgress) => (
        <div
          ...
          className={"container-size p-[0.5em] md:p-[0.75em] gap-[var(--gap)] grid grid-cols-1 grid-rows-2 w-full h-[55.5vw] font-figtree font-black uppercase leading-[0.7125em] text-[clamp(4rem,15vw,12rem)] text-black dark:white"}
        >
