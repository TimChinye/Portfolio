    ...
    return (
        <span
            ...
            className={clsx(
                ...
                // Placeholder styling using ::before
                "empty:before:content-(--placeholder) empty:before:pointer-events-none",
                "empty:before:text-[#2F2F2B80] dark:empty:before:text-[#F5F5EF80]",
                className
            )}
        />
    );
        ...
        >
            ...
            <button
                ...
                className={clsx(
                    ...
                    "border-[#2F2F2B20] dark:border-[#F5F5EF20]",
            ...
            >
                <span className={clsx(
                    ...
                    value ? "text-[#2F2F2B] dark:text-[#F5F5EF]" : "text-[#2F2F2B80] dark:text-[#F5F5EF80]"
                )}>
            ...
            <AnimatePresence>
                {isOpen && !disabled && (
                    <motion.ul
                        ...
                        className={clsx(
                            "absolute left-0 top-full z-999 min-w-full w-max mt-1 py-1",
  ...
  if (state.success) {
    return (
        <motion.div 
            ...
            className="text-center flex flex-col items-center justify-center gap-4 text-[#2F2F2BBF] dark:text-[#F5F5EFBF] font-figtree"
        >
            <h2 className="text-4xl font-bold text-[#D9D24D]">Sent!</h2>
            <p className="text-2xl max-w-md leading-normal">
                Thanks <b>{name}</b>. I&apos;ve received your message and will get back to you at <b>{email}</b> shortly.
            </p>
            <button 
    ...
    return (
        ...
        >
            ...
            <input type="hidden" name="compensation" value={compensationAmount} />
            <input type="hidden" name="compensationPeriod" value={compensationPeriod} />
            ...
            <div className="opacity-0 absolute top-0 left-0 h-0 w-0 overflow-hidden z-[-1]">
                ...
                <input type="text" name="business_url" id="business_url" tabIndex={-1} autoComplete="off" />
            </div>
            ...
            <AnimatePresence>
                {showOpportunityLine && (
                    <motion.div
                        ...
                        className="text-(length:--fs-main) leading-normal"
                    >
            ...
            <AnimatePresence>
                {showLocation && location === "Other" && (
                    <motion.div
                        ...
                        animate={{ height: "auto", opacity: 1 }}
                        exit={{ height: 0, opacity: 0 }}
                        className="overflow-visible text-(length:--fs-main) leading-normal"
                    >
